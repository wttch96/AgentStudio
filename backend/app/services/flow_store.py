"""File-backed flow definitions under the current project."""
...
class FlowStore:
    """Load and manage flow definitions from project YAML files."""

    def __init__(
        self, flows_dir: Path, fallback_dir: Path | None = None,
    ) -> None:
